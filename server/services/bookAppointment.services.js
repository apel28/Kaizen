import { getAppointmentCountByDoctorDateTime } from "../query/appointment.js";
import { getAvailability } from "../query/availability.js";

export async function slotsAvailableByDate(doctorId, date) {
...
x
    ...
    for (const slot of availabilityResult) {
        ...
        if (appointmentCount < slot.slot_duration_minutes) {
            availableSlots.push({ slot_time: slot.slot_time });
        }
    }
